...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || 'mongodb://Ananya:magicpassword@ds215739.mlab.com:15739/startupsdata' || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/sih',
    options: {},
